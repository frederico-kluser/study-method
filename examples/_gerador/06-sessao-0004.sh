...
cat > "$WORK/patch-teach-$N.json" <<'JSON'
{
  ...
  "how_it_happened": [
    ...
    {"move_type": "analogy",
     ...
     "target_topic": "erro-numerico", "outcome": "backfired",
    ...
    {"move_type": "hint_ladder",
     ...
     "target_topic": "erro-numerico", "outcome": "unlocked", "hint_level": 3,
    ...
    {"move_type": "hands_on",
     ...
     "target_topic": "derivada-numerica", "outcome": "unlocked", "hint_level": 3,
